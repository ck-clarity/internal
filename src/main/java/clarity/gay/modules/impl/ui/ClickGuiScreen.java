...
public class ClickGuiScreen extends GuiScreen {
                ...
                for (Module module : ModuleManager.modules.values()) {
                    if (module.getCategory() == category && !module.getName().equals("ClickGui")) {
                        ...
                        if (moduleY + 18 < py + 20 || moduleY > py + panelHeight) {
                            moduleY += 18 + (isModuleExpanded && !module.getModes().isEmpty() ?
                                    (module.getModes().size() * 15) : 0);
                            continue;
                        }
                        ...
                        if (isModuleExpanded && !module.getModes().isEmpty()) {
                            int modeY = moduleY + 18;
                            for (String mode : module.getModes()) {
    ...
    private int calculatePanelHeight(Category category) {
        ...
        for (Module module : ModuleManager.modules.values()) {
            if (module.getCategory() == category && !module.getName().equals("ClickGui")) {
                height += 18;
                if (moduleExpanded.getOrDefault(module, false) && !module.getModes().isEmpty()) {
                    height += (module.getModes().size() * 15);
                }
            }
        }
        return height;
                        ...
                        if (module.getCategory() == category && !module.getName().equals("ClickGui")) {
                            ...
                            if (isInBox(px, px + 110, moduleY, moduleY + 18, mouseX, mouseY)) {
                                if (mouseButton == 0) {
                                    ...
                                    return;
                                } else if (mouseButton == 1 && !module.getModes().isEmpty()) {
